...
public class EJTMTEntireJStackedPane extends Composite
{
    ...
    public EJTMTEntireJStackedPane(Composite parent)
    {
    ...
    public EJTMTEntireJStackedPane(Composite parent, int style)
    {
        super(parent, style);
        _stackLayout = new StackLayout();
        setLayout(_stackLayout);
