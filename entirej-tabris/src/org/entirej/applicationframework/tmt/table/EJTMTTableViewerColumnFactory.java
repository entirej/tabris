...
public class EJTMTTableViewerColumnFactory
{
    private final TableViewer _viewer;

    public EJTMTTableViewerColumnFactory(TableViewer viewer)
    {
        super();
        this._viewer = viewer;
    }
    ...
    public TableViewerColumn createColumn(String header, int width, ColumnLabelProvider provider, EJTMTAbstractTableSorter sorter)
    {
    ...
    public TableViewerColumn createColumn(String header, int width, ColumnLabelProvider provider, int alignment, EJTMTAbstractTableSorter sorter)
    {
        ...
        if (sorter != null)
        {
            new EJTMTTableSortSelectionListener(_viewer, column, sorter, SWT.UP, false);
        }
