...
public class EJTMTTableSortSelectionListener implements SelectionListener
{
     ...
     *            direction
     */
    public EJTMTTableSortSelectionListener(TableViewer viewer, TableColumn column, EJTMTAbstractTableSorter sorter, int defaultDirection, boolean keepDirection)
    {
        _viewer = viewer;
        _column = column;
