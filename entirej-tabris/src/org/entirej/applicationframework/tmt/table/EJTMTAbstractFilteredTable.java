...
public abstract class EJTMTAbstractFilteredTable extends Composite
{
    ...
    public EJTMTAbstractFilteredTable(Composite parent, int treeStyle)
    {
    ...
    protected Control createTreeControl(Composite parent, int style)
    {
        ...
        GridData data = new GridData(SWT.FILL, SWT.FILL, true, true);
        _tableViewer.getControl().setLayoutData(data);
    ...
    public static abstract class FilteredContentProvider implements IStructuredContentProvider
    {
