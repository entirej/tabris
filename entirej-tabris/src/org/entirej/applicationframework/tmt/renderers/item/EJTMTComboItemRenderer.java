...
import org.entirej.applicationframework.tmt.application.components.EJTMTAbstractActionCombo;
import org.entirej.applicationframework.tmt.renderer.interfaces.EJTMTAppItemRenderer;
import org.entirej.applicationframework.tmt.renderers.item.definition.interfaces.EJTMTComboBoxRendererDefinitionProperties;
...
import org.entirej.applicationframework.tmt.renderers.screen.EJTMTAbstractScreenRenderer;
...
public class EJTMTComboItemRenderer implements EJTMTAppItemRenderer, FocusListener, Serializable, EJTMTItemTextChangeNotifier
{
    ...
    protected EJTMTAbstractActionCombo        _actionControl;
    ...
    public void initialise(EJScreenItemController item, EJScreenItemProperties screenItemProperties)
    {
        ...
        _visibleItemCount = _rendererProps.getIntProperty(EJTMTComboBoxRendererDefinitionProperties.VISIBLE_ITEM_COUNT, 0);
        if (_rendererProps.getBooleanProperty(EJTMTComboBoxRendererDefinitionProperties.INITIALIES_LOV, true))
        {
            loadComboBoxValues();
        }
    }
    ...
    private void loadComboBoxValues()
    {
        ...
        _comboValues.clear();
        _comboKays.clear();
        String lovDefName = _rendererProps.getStringProperty(EJTMTComboBoxRendererDefinitionProperties.LOV_DEFINITION_NAME);
    ...
    private void refreshFont()
    {
        if (controlState(_comboField))
        {
            _comboField.setFont(EJTMTVisualAttributeUtils.INSTANCE.getFont(_visualAttributeProperties, _visualContext.getItemFont()));
        }
    }
    ...
    {
        _actionControl = new EJTMTAbstractActionCombo(composite)
        {
            ...
            public Combo createCombo(Composite parent)
            {
                ...
                _comboField.addFocusListener(EJTMTComboItemRenderer.this);
        ...
        _visualContext = new EJTMTItemRendererVisualContext(_comboField.getBackground(), _comboField.getForeground(), _comboField.getFont());
    ...
    class ComboBoxValue
    {
        ...
        private void constructStringValue(EJDataRecord record, String lovItemName)
        {
            ...
            final EJFrameworkExtensionPropertyList propertyList = _rendererProps.getPropertyList(EJTMTComboBoxRendererDefinitionProperties.DISPLAY_COLUMNS);
            ...
            {
                String format = entry.getProperty(EJTMTComboBoxRendererDefinitionProperties.COLUMN_FORMAT);
                boolean display = Boolean.valueOf(entry.getProperty(EJTMTComboBoxRendererDefinitionProperties.COLUMN_DISPLAYED));
                String returnItem = entry.getProperty(EJTMTComboBoxRendererDefinitionProperties.COLUMN_RETURN_ITEM);
        ...
        public void populateReturnItems(EJBlockController controller, EJScreenType screenType)
        {
            for (String itemName : _returnItemValues.keySet())
            {
                ...
                EJTMTAbstractScreenRenderer abstractScreenRenderer = null;
                switch (screenType)
                {
                    case MAIN:
                    ...
                    case INSERT:
                        ...
                        break;
                    case QUERY:
                        abstractScreenRenderer = (EJTMTAbstractScreenRenderer) controller.getManagedQueryScreenRenderer().getUnmanagedRenderer();
                        break;
                    case UPDATE:
                        abstractScreenRenderer = (EJTMTAbstractScreenRenderer) controller.getManagedUpdateScreenRenderer().getUnmanagedRenderer();
                        break;
                }
