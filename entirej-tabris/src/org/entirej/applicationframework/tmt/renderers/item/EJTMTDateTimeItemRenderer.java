...
import org.entirej.applicationframework.tmt.application.components.EJTMTAbstractActionDateTime;
import org.entirej.applicationframework.tmt.renderer.interfaces.EJTMTAppItemRenderer;
import org.entirej.applicationframework.tmt.renderers.item.definition.interfaces.EJTMTDateTimeItemRendererDefinitionProperties;
...
public class EJTMTDateTimeItemRenderer implements EJTMTAppItemRenderer, FocusListener, Serializable, EJTMTItemTextChangeNotifier
{
    ...
    protected EJTMTAbstractActionDateTime     _actionControl;
    ...
    public void createComponent(Composite composite)
    {
        ...
        {
            _actionControl = new EJTMTAbstractActionDateTime(composite)
            {
                ...
                public DateTime createText(Composite parent)
                {
                    ...
                    String details = _rendererProps.getStringProperty(EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS);
                    if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS_LONG.equals(details))
                    {
                        style = style | SWT.LONG;
                    }
                    else if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS_MEDIUM.equals(details))
                    {
                        style = style | SWT.MEDIUM;
                    }
                    else if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS_SHORT.equals(details))
                    {
                        style = style | SWT.SHORT;
                    }
                    String type = _rendererProps.getStringProperty(EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_TYPE);
                    if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_TYPE_CALENDAR.equals(type))
                    {
                        style = style | SWT.CALENDAR;
                    }
                    else if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_TYPE_DATE.equals(type))
                    {
                        style = style | SWT.DATE;
                    }
                    else if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_TYPE_TIME.equals(type))
                    {
                        style = style | SWT.TIME;
                    }

                    if (_rendererProps.getBooleanProperty(EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DROP_DOWN, false))
                    {
    ...
    public void initialise(EJScreenItemController item, EJScreenItemProperties screenItemProperties)
    {
        ...
        _displayValueAsLabel = _rendererProps.getBooleanProperty(EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DISPLAY_VAUE_AS_LABEL, false);
    ...
    protected static DateFormat createDateFormat(EJScreenItemController item)
    {
        ...
        String format = rendererProps.getStringProperty(EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS);
        boolean istime = EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_TYPE_TIME.equals(rendererProps
                .getStringProperty(EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_TYPE));
        if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS_LONG.equals(format))
        {
        ...
        else if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS_MEDIUM.equals(format))
        {
        ...
        else if (EJTMTDateTimeItemRendererDefinitionProperties.PROPERTY_DETAILS_SHORT.equals(format))
        {
