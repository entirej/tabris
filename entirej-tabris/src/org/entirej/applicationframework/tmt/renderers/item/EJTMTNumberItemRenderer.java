...
public class EJTMTNumberItemRenderer extends EJTMTTextItemRenderer implements Serializable
{
    ...
    protected Text newTextField(Composite composite, int style)
    {
        ...
        if (_rendererProps != null && _rendererProps.getBooleanProperty(EJTMTTextItemRendererDefinitionProperties.PROPERTY_SELECT_ON_FOCUS, true))
        {
            _textField.addFocusListener(new FocusListener()
            {
                @Override
    ...
    private static DecimalFormat createFormatter(EJScreenItemController item, NUMBER_TYPE numberType)
    {
        ...
        String format = _rendererProps.getStringProperty(EJTMTTextItemRendererDefinitionProperties.PROPERTY_FORMAT);
