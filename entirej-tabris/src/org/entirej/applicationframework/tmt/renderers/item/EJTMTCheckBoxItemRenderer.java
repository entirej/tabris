...
import org.entirej.applicationframework.tmt.renderers.item.definition.interfaces.EJTMTCheckBoxRendererDefinitionProperties;
...
public class EJTMTCheckBoxItemRenderer extends EJTMTButtonItemRenderer
{
    ...
    public void initialise(EJScreenItemController item, EJScreenItemProperties screenItemProperties)
    {
        ...
        final String checkedValue = _rendererProps.getStringProperty(EJTMTCheckBoxRendererDefinitionProperties.CHECKED_VALUE);
        final String uncheckedValue = _rendererProps.getStringProperty(EJTMTCheckBoxRendererDefinitionProperties.UNCHECKED_VALUE);
        final String otherValueMapping = _rendererProps.getStringProperty(EJTMTCheckBoxRendererDefinitionProperties.OTHER_VALUE_MAPPING);
        ...
        {
            _useTriStateChaeckBox = _rendererProps.getBooleanProperty(EJTMTCheckBoxRendererDefinitionProperties.TRI_STATE, false);
        }
        ...
        _otherValueMappingValue = EJTMTCheckBoxRendererDefinitionProperties.CHECKED.equals(otherValueMapping);

        _defaultValue = _itemProperties.getItemRendererProperties().getStringProperty(EJTMTCheckBoxRendererDefinitionProperties.DEFAULT_VALUE);
    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                _button.setSelection(EJTMTCheckBoxRendererDefinitionProperties.CHECKED.equals(_defaultValue));
                            }
                        }
                    }
                }
    ...
    public ColumnLabelProvider createColumnLabelProvider(final EJScreenItemProperties item, final EJScreenItemController controller)
    {
        ...
        final Object checkedValue = getValueAsObject(itemProperties.getDataTypeClass(),
                itemRendererProperties.getStringProperty(EJTMTCheckBoxRendererDefinitionProperties.CHECKED_VALUE));
        final Object uncheckedValue = getValueAsObject(itemProperties.getDataTypeClass(),
                itemRendererProperties.getStringProperty(EJTMTCheckBoxRendererDefinitionProperties.UNCHECKED_VALUE));
        final boolean otherValueMappingValue = EJTMTCheckBoxRendererDefinitionProperties.CHECKED.equals(itemRendererProperties
                .getStringProperty(EJTMTCheckBoxRendererDefinitionProperties.OTHER_VALUE_MAPPING));
        final boolean defaultState = EJTMTCheckBoxRendererDefinitionProperties.CHECKED.equals(otherValueMappingValue);
            ...
            public Image getImage(Object element)
            {
                if (element instanceof EJDataRecord)
                {
                    ...
                    if (value != null)
                    {
                        ...
                        {
                            return EJTMTImageRetriever.get(EJTMTImageRetriever.IMG_CHECK_SELECTED);
                        }
                        else if (value.equals(uncheckedValue))
                        {
                            return EJTMTImageRetriever.get(EJTMTImageRetriever.IMG_CHECK_UNSELECTED);
                        }
                        else
                        {
