...
public class EJTMTLookupFormLovRenderer extends EJTMTStandardLovRenderer
{
    private EJQueryScreenRenderer _queryScreenRenderer;

    public EJTMTLookupFormLovRenderer()
    {
    ...
    protected Control createToolbar(Composite parent)
    {
        ...
        search.setImage(EJTMTImageRetriever.get(EJTMTImageRetriever.IMG_FIND_LOV));
