...
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_ALIGNMENT;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_ALIGNMENT_CENTER;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_ALIGNMENT_LEFT;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_ALIGNMENT_RIGHT;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_CASE;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_CASE_LOWER;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_CASE_MIXED;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_CASE_UPPER;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_DISPLAY_VAUE_AS_LABEL;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_MAXLENGTH;
import static org.entirej.applicationframework.tmt.renderers.item.definition.EJTMTTextItemRendererDefinition.PROPERTY_WRAP;
...
public class EJTMTTextAreaRendererDefinition implements EJDevItemRendererDefinition
{

    public EJTMTTextAreaRendererDefinition()
    {
    }

    public String getRendererClassName()
    {
        return "org.entirej.applicationframework.tmt.renderers.item.EJTMTTextAreaRenderer";
    }
