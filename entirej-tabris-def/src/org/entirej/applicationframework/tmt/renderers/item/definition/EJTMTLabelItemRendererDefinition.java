...
public class EJTMTLabelItemRendererDefinition implements EJDevItemRendererDefinition
{
    ...
    {
        return "org.entirej.applicationframework.tmt.renderers.item.EJTMTLabelItemRenderer";
    }
    ...
    {
        Label text = new Label(parent, SWT.NULL); // toolkit.createText(parent,
