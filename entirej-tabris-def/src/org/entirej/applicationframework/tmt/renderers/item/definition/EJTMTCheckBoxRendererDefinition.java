...
public class EJTMTCheckBoxRendererDefinition implements EJDevItemRendererDefinition
{
    ...
    public EJTMTCheckBoxRendererDefinition()
    {
    }

    public String getRendererClassName()
    {
        return "org.entirej.applicationframework.tmt.renderers.item.EJTMTCheckBoxItemRenderer";
    }
    ...
    public EJPropertyDefinitionGroup getItemPropertyDefinitionGroup()
    {
        ...
        EJDevPropertyDefinition checkedValue = new EJDevPropertyDefinition(EJTMTCheckBoxRendererDefinition.CHECKED_VALUE, EJPropertyDefinitionType.STRING);
        ...
        EJDevPropertyDefinition uncheckedValue = new EJDevPropertyDefinition(EJTMTCheckBoxRendererDefinition.UNCHECKED_VALUE, EJPropertyDefinitionType.STRING);
        ...
        EJDevPropertyDefinition initialValue = new EJDevPropertyDefinition(EJTMTCheckBoxRendererDefinition.DEFAULT_VALUE, EJPropertyDefinitionType.STRING);
        ...
        initialValue.addValidValue(EJTMTCheckBoxRendererDefinition.CHECKED, "Checked");
        initialValue.addValidValue(EJTMTCheckBoxRendererDefinition.UNCHECKED, "Unchecked");
        initialValue.setDefaultValue(EJTMTCheckBoxRendererDefinition.CHECKED);

        EJDevPropertyDefinition otherValueMapping = new EJDevPropertyDefinition(EJTMTCheckBoxRendererDefinition.OTHER_VALUE_MAPPING,
        ...
        otherValueMapping.addValidValue(EJTMTCheckBoxRendererDefinition.CHECKED, "Checked");
        otherValueMapping.addValidValue(EJTMTCheckBoxRendererDefinition.UNCHECKED, "Unchecked");
        otherValueMapping.setDefaultValue(EJTMTCheckBoxRendererDefinition.CHECKED);
        otherValueMapping.setMandatory(true);

        EJDevPropertyDefinition triState = new EJDevPropertyDefinition(EJTMTCheckBoxRendererDefinition.TRI_STATE, EJPropertyDefinitionType.BOOLEAN);
