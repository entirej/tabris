...
public class EJTMTInsertScreenRendererDefinition extends EJTMTScreenRendererDefinition implements EJDevInsertScreenRendererDefinition
{
    public String getRendererClassName()
    {
        return "org.entirej.applicationframework.tmt.renderers.screen.EJTMTInsertScreenRenderer";
    }
    ...
    {
        int height = blockDisplayProperties.getInsertScreenRendererProperties().getIntProperty(EJTMTScreenRendererDefinitionProperties.HEIGHT, 300);
        int width = blockDisplayProperties.getInsertScreenRendererProperties().getIntProperty(EJTMTScreenRendererDefinitionProperties.WIDTH, 300);
        int numcols = blockDisplayProperties.getInsertScreenRendererProperties().getIntProperty(EJTMTScreenRendererDefinitionProperties.NUM_COLS, 1);
