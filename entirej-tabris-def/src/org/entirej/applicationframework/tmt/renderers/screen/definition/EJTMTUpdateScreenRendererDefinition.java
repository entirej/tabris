...
public class EJTMTUpdateScreenRendererDefinition extends EJTMTScreenRendererDefinition implements EJDevUpdateScreenRendererDefinition
{
    public String getRendererClassName()
    {
        return "org.entirej.applicationframework.tmt.renderers.screen.EJTMTUpdateScreenRenderer";
    }
    ...
    public EJPropertyDefinitionGroup getUpdateScreenPropertyDefinitionGroup()
    {
        ...
        EJDevPropertyDefinition save = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.SAVE_FORM_AFTER_EXECUTE,
    ...
    {
        int height = blockDisplayProperties.getUpdateScreenRendererProperties().getIntProperty(EJTMTScreenRendererDefinitionProperties.HEIGHT, 300);
        int width = blockDisplayProperties.getUpdateScreenRendererProperties().getIntProperty(EJTMTScreenRendererDefinitionProperties.WIDTH, 300);
        int numcols = blockDisplayProperties.getUpdateScreenRendererProperties().getIntProperty(EJTMTScreenRendererDefinitionProperties.NUM_COLS, 1);
