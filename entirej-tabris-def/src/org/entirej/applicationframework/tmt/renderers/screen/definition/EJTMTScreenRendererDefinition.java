...
public abstract class EJTMTScreenRendererDefinition implements EJRendererDefinition
{
    ...
    protected EJPropertyDefinitionGroup getScreenPropertyDefinitions()
    {
        ...
        EJDevPropertyDefinition title = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.TITLE, EJPropertyDefinitionType.STRING);
        title.setLabel("Title");
        title.setDescription("The title displayed in the screen window");
        title.setMultilingual(true);

        EJDevPropertyDefinition width = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.WIDTH, EJPropertyDefinitionType.INTEGER);
        width.setLabel("Width");
        width.setDescription("The width of the screen");
        width.setDefaultValue("300");
        width.setMandatory(true);

        EJDevPropertyDefinition height = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.HEIGHT, EJPropertyDefinitionType.INTEGER);
        ...
        EJDevPropertyDefinition numCols = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.NUM_COLS, EJPropertyDefinitionType.INTEGER);
        ...
        EJDevPropertyDefinition cancelButtonLabel = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.CANCEL_BUTTON_TEXT,
        ...
        EJDevPropertyDefinition saveButtonLabel = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXECUTE_BUTTON_TEXT,
                EJPropertyDefinitionType.STRING);
    ...
    {
        EJDevPropertyDefinition extraButton1Label = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_ONE_LABEL,
                EJPropertyDefinitionType.STRING);
        ...
        EJDevPropertyDefinition extraButton1Command = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_ONE_COMMAND,
                EJPropertyDefinitionType.ACTION_COMMAND);
        ...
        EJDevPropertyDefinition extraButton2Label = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_TWO_LABEL,
                EJPropertyDefinitionType.STRING);
        ...
        EJDevPropertyDefinition extraButton2Command = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_TWO_COMMAND,
                EJPropertyDefinitionType.ACTION_COMMAND);
        ...
        EJDevPropertyDefinition extraButton3Label = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_THREE_LABEL,
                EJPropertyDefinitionType.STRING);
        ...
        EJDevPropertyDefinition extraButton3Command = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_THREE_COMMAND,
                EJPropertyDefinitionType.ACTION_COMMAND);
        ...
        EJDevPropertyDefinition extraButton4Label = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_FOUR_LABEL,
                EJPropertyDefinitionType.STRING);
        ...
        EJDevPropertyDefinition extraButton4Command = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_FOUR_COMMAND,
                EJPropertyDefinitionType.ACTION_COMMAND);
        ...
        EJDevPropertyDefinition extraButton5Label = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_FIVE_LABEL,
                EJPropertyDefinitionType.STRING);
        ...
        EJDevPropertyDefinition extraButton5Command = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTON_FIVE_COMMAND,
                EJPropertyDefinitionType.ACTION_COMMAND);
        ...
        EJDevPropertyDefinitionGroup extraButtonGroup = new EJDevPropertyDefinitionGroup(EJTMTScreenRendererDefinitionProperties.EXTRA_BUTTONS_GROUP);
    ...
    protected EJPropertyDefinitionGroup getItemPropertyDefinitions()
    {
        ...
        EJDevPropertyDefinition itemPosition = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.ITEM_POSITION_PROPERTY,
                EJPropertyDefinitionType.STRING);
        ...
        itemPosition.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_LEFT_PROPERTY, "Left");
        itemPosition.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_RIGHT_PROPERTY, "Right");
        itemPosition.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_CENTER_PROPERTY, "Center");
        itemPosition.setDefaultValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_LEFT_PROPERTY);
        itemPosition.setMandatory(true);

        EJDevPropertyDefinition labelPosition = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.LABEL_POSITION_PROPERTY,
                EJPropertyDefinitionType.STRING);
        ...
        labelPosition.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_POSITION_LEFT_PROPERTY, "Left");
        labelPosition.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_POSITION_RIGHT_PROPERTY, "Right");
        labelPosition.setDefaultValue(EJTMTScreenRendererDefinitionProperties.LABEL_POSITION_LEFT_PROPERTY);

        EJDevPropertyDefinition labelOrientation = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_PROPERTY,
                EJPropertyDefinitionType.STRING);
        labelOrientation.setLabel("Label Orientation");
        labelOrientation.setDescription("The orientation of the labels text");
        labelOrientation.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_LEFT_PROPERTY, "Left");
        labelOrientation.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_RIGHT_PROPERTY, "Right");
        labelOrientation.addValidValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_CENTER_PROPERTY, "Center");
        labelOrientation.setDefaultValue(EJTMTScreenRendererDefinitionProperties.LABEL_ORIENTATION_RIGHT_PROPERTY);
        labelOrientation.setMandatory(true);

        EJDevPropertyDefinition horizontalSpan = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.HORIZONTAL_SPAN,
        ...
        EJDevPropertyDefinition verticalSpan = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.VERTICAL_SPAN,
                EJPropertyDefinitionType.INTEGER);
        ...
        EJDevPropertyDefinition expandHorizontally = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXPAND_HORIZONTALLY,
                EJPropertyDefinitionType.BOOLEAN);
        ...
        EJDevPropertyDefinition expandVertically = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXPAND_VERTICALLY,
                EJPropertyDefinitionType.BOOLEAN);
        ...
        EJDevPropertyDefinition visualAttribute = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.VISUAL_ATTRIBUTE_PROPERTY,
    ...
    public EJPropertyDefinitionGroup getSpacerItemPropertyDefinitionGroup()
    {
        ...
        EJDevPropertyDefinition expandx = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXPAND_HORIZONTALLY,
                EJPropertyDefinitionType.BOOLEAN);
        ...
        EJDevPropertyDefinition expandy = new EJDevPropertyDefinition(EJTMTScreenRendererDefinitionProperties.EXPAND_VERTICALLY,
                EJPropertyDefinitionType.BOOLEAN);
